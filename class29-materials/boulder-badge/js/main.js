...
const bulbaNeeds = 16 - 5
const caterpieNeeds = 7 - 1
const weedleNeeds = 7 - 1
const candiesNeeded = bulbaNeeds + caterpieNeeds + weedleNeeds
...
function charmanderCanBattle (temp) {
  return fahrenheitToCelsius(temp) > 0
}
...
const x = 17
console.log('Pikachu I choose you'.repeat(x))